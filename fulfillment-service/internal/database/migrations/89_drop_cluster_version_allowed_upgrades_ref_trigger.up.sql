...
-- Drop the allowed_upgrades referential integrity trigger and function added in migration 81. The
-- ClusterVersionSpec.allowed_upgrades field has been removed from the API, so the trigger no longer applies.
