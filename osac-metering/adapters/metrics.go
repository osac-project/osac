...
func newAdapterMetrics(provider string) *adapterMetrics {
	...
	m := &adapterMetrics{
		...
		consumerLag: prometheus.NewGaugeVec(prometheus.GaugeOpts{
			Name: "osac_adapter_consumer_lag_events",
			Help: "Estimated consumer lag in number of events.",
		}, []string{"provider", "topic"}),
	...
	reg.MustRegister(
		...
		m.duplicatesSuppressed, m.outOfOrderEvents, m.consumerLag,
