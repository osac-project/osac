...
const BareMetalInstanceStateRunning = "RUNNING"
...
func (m *bareMetalInstanceMapper) CurrentState() string {
	...
	return strings.TrimPrefix(state.String(), BareMetalInstanceStatePrefix)
}
...
func (m *bareMetalInstanceMapper) TransitionTime(event *privatev1.Event) (time.Time, error) {
