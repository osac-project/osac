...
class TestGenerateAll(unittest.TestCase):
    ...
    def test_fetches_shared_repositories_once_and_writes_each_dashboard(self, mock_fetch):
        mock_fetch.return_value = [_pr("alice"), _pr("bob")]
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_fetch.assert_called_once_with(["osac-project/osac"])
            ...
            self.assertEqual(len(general["repos"][0]["prs"]), 2)
