...
def default_networking(
    grpc: GRPCClient, k8s_hub_client: K8sClient, network_class: str, test_run_id: str
) -> dict[str, str]:
    """
    ...
    try:
        ...
        vn_id = grpc.create_virtual_network(name=vn_name, network_class=network_class, ipv4_cidr="10.200.0.0/16")
