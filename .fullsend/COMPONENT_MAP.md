...
2. **Helm CRD copy**: `osac-installer/charts/osac-operator/crds/<crd>.yaml`
...
3. **RBAC markers vs Helm ClusterRole**:
   ...
   - Destination: `osac-installer/charts/osac-operator/templates/clusterrole.yaml`
...
3. **Parent command registration**: `fulfillment-service/internal/cmd/cli/root.go` or `<parent_cmd>.go`
