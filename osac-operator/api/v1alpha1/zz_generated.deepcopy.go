...
func (in *AddOnOperatorJobStatus) DeepCopyInto(out *AddOnOperatorJobStatus) {
	*out = *in
	in.JobStatus.DeepCopyInto(&out.JobStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddOnOperatorJobStatus.
func (in *AddOnOperatorJobStatus) DeepCopy() *AddOnOperatorJobStatus {
	if in == nil {
		return nil
	}
	out := new(AddOnOperatorJobStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterOrderStatus) DeepCopyInto(out *ClusterOrderStatus) {
	*out = *in
	...
	if in.AddOnOperatorJobs != nil {
		in, out := &in.AddOnOperatorJobs, &out.AddOnOperatorJobs
		*out = make([]AddOnOperatorJobStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
